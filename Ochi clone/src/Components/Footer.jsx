...
function Footer() {
  return (
    ...
    className="w-full h-full  flex gap-[15vw] py-[5vw]  px-[4vw] bg-[#f1f1f1]">
        ...
        <div className="links flex justify-between ">
          <div className=" left ">
            ...
            <div className="dets">
              <h1>E:</h1>
              <br />
              <a className="block" href="https://github.com/Krish2643">
                <u>hello@Krish.design</u>
              </a>
            </div>
          </div>
          <div className="right pt-[20vh]">
            <div>
              ...
              <a className="block" href="https://www.linkedin.com/in/parmarkrish2643">
                <u>Contact us</u>
              </a>
            </div>
          </div>
